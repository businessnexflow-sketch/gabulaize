  ...
  return (
    ...
    >
      ...
      <div className="pt-4 space-y-6">
        ...
        {/* Combined pensioner / socially vulnerable toggle */}
        <div className="bg-muted/40 p-5 rounded-2xl border border-border/50 flex items-center justify-between">
          <div className="space-y-0.5">
            <Label className="text-base font-semibold">პენსიონერი / სოც. დაუცველი</Label>
            <p className="text-sm text-muted-foreground">
              მონიშნეთ, თუ განმცხადებელი პენსიონერია ან სოციალურად დაუცველი.
            </p>
          </div>
          <Switch
            checked={!!(data.sociallyVulnerable || data.pensioner)}
            onCheckedChange={(c) =>
              updateData({
        ...
        <div className="bg-muted/40 p-5 rounded-2xl border border-border/50 flex items-center justify-between">
          <div className="space-y-0.5">
            <Label className="text-base font-semibold">მომთაბარე</Label>
            <p className="text-sm text-muted-foreground">არის თუ არა განმცხადებელი მომთაბარე?</p>
          </div>
          <Switch 
            checked={data.nomadic || false} 
            onCheckedChange={(c) => updateData({ nomadic: c })}
          />
        </div>
